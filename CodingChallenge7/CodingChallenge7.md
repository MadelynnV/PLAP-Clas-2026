...
```
    ...
    ## Warning: package 'multcompView' was built under R version 4.5.2
...
- The intercept (182.163) represents the expected emergence for
  Treatment 1 at day 0 of DaysAfterPlanting

- The coefficient for Treatment 2 (-134.531) indicates that emergence
  is, on average 134.5 units lower then treatment 1 with
  DaysAfterPlanting being constant.
...
- Treatment 2 has significantly lower emergence than all other treatment
  groups.

- Treatment 7 has high emergence then treatment 2, but is lower than the
  top-performing treatment and significantly different from both the
  lowest and the highest group of emergence.

- Treatments 1, 4, 8, and 9 are not significant different from either
  treatment 7 or the highest emergence group.

- Treatments 3, 5, and 6 have the highest emergence but are not
  significantly different from treatments 1, 4, 8, and 9.
...
- Letter ‘a’ includes treatments 3, 5, and 6 are have the highest
  emergence but are not significantly different between group ‘ab’

- Letters ‘ab’ mean treatment 1, 4, 8 and 9 are not significantly
  different from each group a and group b as they share similar
  components of both groups.

- Letter ‘b’ includes treatment 7 that has the a intermediate level of
  emergence and is significant lower then group a and higher then group
  c. 

- Letter ‘c’ includes treatment 2 that has the significantly lowest
  level of emergence compared to groups a and b.
...
[Link to CodingChallenge7 folder on
GitHub](https://github.com/MadelynnV/PLAP-Clas-2026/tree/main/CodingChallenge7)
